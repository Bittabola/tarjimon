...
GEMINI_INPUT_PRICE_PER_M = PRICING_CONSTANTS.GEMINI_INPUT_PRICE_PER_M
GEMINI_OUTPUT_PRICE_PER_M = PRICING_CONSTANTS.GEMINI_OUTPUT_PRICE_PER_M
GEMINI_INPUT_PRICE_PER_M_LONG = PRICING_CONSTANTS.GEMINI_INPUT_PRICE_PER_M_LONG
GEMINI_OUTPUT_PRICE_PER_M_LONG = PRICING_CONSTANTS.GEMINI_OUTPUT_PRICE_PER_M_LONG
GEMINI_LONG_CONTEXT_THRESHOLD = PRICING_CONSTANTS.GEMINI_LONG_CONTEXT_THRESHOLD

# --- Revenue Settings ---
STARS_TO_USD = PRICING_CONSTANTS.STARS_TO_USD
TELEGRAM_FEE_PERCENT = PRICING_CONSTANTS.TELEGRAM_FEE_PERCENT
NET_REVENUE_PER_STAR = STARS_TO_USD * (1 - TELEGRAM_FEE_PERCENT / 100)

# Premium tier limits
PREMIUM_YOUTUBE_MINUTES_LIMIT = SUBSCRIPTION_LIMITS.PREMIUM_YOUTUBE_MINUTES
PREMIUM_TRANSLATION_LIMIT = SUBSCRIPTION_LIMITS.PREMIUM_TRANSLATIONS

# Premium package value breakdown for amortized P/L calculation
PREMIUM_NET_REVENUE = SUBSCRIPTION_LIMITS.PREMIUM_PRICE_STARS * NET_REVENUE_PER_STAR
PREMIUM_VIDEO_SHARE = 0.80
PREMIUM_TRANSLATION_SHARE = 0.20
REVENUE_PER_VIDEO_MINUTE = (
    PREMIUM_NET_REVENUE * PREMIUM_VIDEO_SHARE
) / PREMIUM_YOUTUBE_MINUTES_LIMIT
REVENUE_PER_TRANSLATION = (
    PREMIUM_NET_REVENUE * PREMIUM_TRANSLATION_SHARE
) / PREMIUM_TRANSLATION_LIMIT

# User rate limiting settings (re-export for backward compatibility)
DAILY_USER_TOKEN_LIMIT = RATE_LIMITS.DAILY_TOKENS_PER_USER
REQUEST_RATE_LIMIT = RATE_LIMITS.REQUESTS_PER_MINUTE
MAX_TEXT_LENGTH = TEXT_LIMITS.MAX_TEXT_LENGTH
MAX_IMAGE_SIZE_MB = IMAGE_LIMITS.MAX_IMAGE_SIZE_MB

# --- Translation Settings ---
MAX_CHUNK_SIZE = TEXT_LIMITS.MAX_CHUNK_SIZE
SHORT_TEXT_THRESHOLD = TEXT_LIMITS.SHORT_TEXT_THRESHOLD
MAX_OUTPUT_TOKENS = TEXT_LIMITS.MAX_OUTPUT_TOKENS
LONG_TEXT_OUTPUT_TOKENS = TEXT_LIMITS.LONG_TEXT_OUTPUT_TOKENS
TRANSLATION_TEMPERATURE = 0.0

# Translation retry settings
MAX_TRANSLATION_RETRIES = RETRY_CONSTANTS.MAX_TRANSLATION_RETRIES
CHUNK_DELAY_SECONDS = RETRY_CONSTANTS.CHUNK_DELAY_SECONDS
RETRY_DELAY_SECONDS = RETRY_CONSTANTS.RETRY_DELAY_SECONDS

# Token estimation constants
TOKEN_ESTIMATION_RATIO = TEXT_LIMITS.TOKEN_ESTIMATION_RATIO

# Translation quality thresholds
MIN_TRANSLATION_LENGTH_RATIO = TEXT_LIMITS.MIN_TRANSLATION_LENGTH_RATIO
MAX_TRANSLATION_LENGTH_RATIO = TEXT_LIMITS.MAX_TRANSLATION_LENGTH_RATIO
MIN_ORIGINAL_LENGTH_FOR_RATIO_CHECK = TEXT_LIMITS.MIN_ORIGINAL_LENGTH_FOR_RATIO_CHECK

# --- Image Processing Settings ---
OCR_MAX_TOKENS = IMAGE_LIMITS.OCR_MAX_TOKENS
OCR_TEMPERATURE = IMAGE_LIMITS.OCR_TEMPERATURE
OCR_FALLBACK_TEXT_LENGTH = IMAGE_LIMITS.OCR_FALLBACK_TEXT_LENGTH
UZBEK_DETECTION_THRESHOLD = IMAGE_LIMITS.UZBEK_DETECTION_THRESHOLD

# Image processing limits
MAX_IMAGE_DIMENSION = IMAGE_LIMITS.MAX_IMAGE_DIMENSION
IMAGE_COMPRESSION_QUALITY = IMAGE_LIMITS.IMAGE_COMPRESSION_QUALITY
# Re-export SUPPORTED_IMAGE_FORMATS (already imported from constants)

# Session management constants
SESSION_CLEANUP_INTERVAL = SESSION_CONSTANTS.CLEANUP_INTERVAL_SECONDS
SESSION_TIMEOUT_SECONDS = SESSION_CONSTANTS.TIMEOUT_SECONDS
MAX_INACTIVE_SESSIONS = SESSION_CONSTANTS.MAX_INACTIVE_SESSIONS

# Error logging and debugging constants
ERROR_LOG_CONTEXT_ENABLED = ERROR_LOG_CONSTANTS.CONTEXT_ENABLED
ERROR_LOG_MAX_TRACEBACK_LINES = ERROR_LOG_CONSTANTS.MAX_TRACEBACK_LINES
ERROR_LOG_MAX_TEXT_PREVIEW = ERROR_LOG_CONSTANTS.MAX_TEXT_PREVIEW
DEBUG_INCLUDE_USER_CONTEXT = ERROR_LOG_CONSTANTS.INCLUDE_USER_CONTEXT

# --- YouTube Summarization Settings ---
YOUTUBE_MAX_OUTPUT_TOKENS = YOUTUBE_LIMITS.MAX_OUTPUT_TOKENS
YOUTUBE_FOLLOWUP_MAX_TOKENS = YOUTUBE_LIMITS.FOLLOWUP_MAX_TOKENS
YOUTUBE_TEMPERATURE = YOUTUBE_LIMITS.TEMPERATURE
YOUTUBE_MAX_DURATION_MINUTES = YOUTUBE_LIMITS.MAX_DURATION_MINUTES
YOUTUBE_NO_TRANSCRIPT_MULTIPLIER = YOUTUBE_LIMITS.NO_TRANSCRIPT_MULTIPLIER
YOUTUBE_CACHE_TTL_SECONDS = YOUTUBE_LIMITS.CACHE_TTL_SECONDS
QUESTION_BUTTON_MAX_LENGTH = YOUTUBE_LIMITS.QUESTION_BUTTON_MAX_LENGTH

# --- Subscription & Limits Settings ---
QUOTA_PERIOD_DAYS = SUBSCRIPTION_LIMITS.FREE_PERIOD_DAYS
FREE_YOUTUBE_MINUTES_LIMIT = SUBSCRIPTION_LIMITS.FREE_YOUTUBE_MINUTES
FREE_TRANSLATION_LIMIT = SUBSCRIPTION_LIMITS.FREE_TRANSLATIONS
...
SUBSCRIPTION_PLAN = {
    ...
    "youtube_minutes_limit": PREMIUM_YOUTUBE_MINUTES_LIMIT,
    "translation_limit": PREMIUM_TRANSLATION_LIMIT,
}

# Re-export MONTHS_UZ (already imported from constants)
